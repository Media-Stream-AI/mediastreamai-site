    ...
    <header className="flex justify-between items-center px-4 md:px-6 py-3 md:py-4 bg-black/95 backdrop-blur-md sticky top-0 z-[100] border-b border-white/10">
      ...
      <nav className="hidden lg:flex items-center space-x-2 xl:space-x-4 text-sm xl:text-base">
        ...
        <div className="relative group">
          ...
          <div className="absolute top-full left-0 mt-2 w-96 bg-black border-2 border-white/30 rounded-xl shadow-2xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all z-[9999] overflow-hidden">
            <div className="p-6 space-y-3">
              <Link href="/solutions" className="block px-5 py-4 text-white/80 hover:text-white hover:bg-white/10 rounded-lg transition-colors">
                <div className="font-semibold text-lg mb-2">Solutions Overview</div>
                <div className="text-sm text-white/50">GPU vs AI Agents</div>
              </Link>
              <a href="https://gpu.mediastreamai.com" target="_blank" rel="noopener noreferrer" className="block px-5 py-4 text-white/80 hover:text-white hover:bg-white/10 rounded-lg transition-colors">
                <div className="font-semibold text-lg mb-2 flex items-center gap-2">
                  GPU-as-a-Service <ExternalLink size={16} />
                </div>
                <div className="text-sm text-white/50">H200, B200, SambaNova RDU</div>
              </a>
              <a href="https://mother.mediastreamai.com" target="_blank" rel="noopener noreferrer" className="block px-5 py-4 text-white/80 hover:text-white hover:bg-white/10 rounded-lg transition-colors">
                <div className="font-semibold text-lg mb-2 flex items-center gap-2">
                  MOTHER AI Agents <ExternalLink size={16} />
                </div>
        ...
        <div className="relative group">
          ...
          <div className="absolute top-full left-0 mt-2 w-96 bg-black border-2 border-white/30 rounded-xl shadow-2xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all z-[9999] overflow-hidden">
            <div className="p-6 space-y-2">
              <Link href="/sectors#media" className="block px-5 py-3 text-white/80 hover:text-white hover:bg-white/10 rounded-lg transition-colors">
                <div className="font-medium text-base">Media & Broadcasting</div>
              </Link>
              <Link href="/sectors#film" className="block px-5 py-3 text-white/80 hover:text-white hover:bg-white/10 rounded-lg transition-colors">
                <div className="font-medium text-base">Film & TV Production</div>
              </Link>
              <Link href="/sectors#creative" className="block px-5 py-3 text-white/80 hover:text-white hover:bg-white/10 rounded-lg transition-colors">
                <div className="font-medium text-base">Creative Industries</div>
              </Link>
              <Link href="/sectors#advertising" className="block px-5 py-3 text-white/80 hover:text-white hover:bg-white/10 rounded-lg transition-colors">
                <div className="font-medium text-base">Advertising</div>
              </Link>
              <Link href="/government-defence" className="block px-5 py-3 text-white/80 hover:text-white hover:bg-white/10 rounded-lg transition-colors">
                <div className="font-medium text-base">Government & Defence</div>
              </Link>
              <Link href="/sectors#research" className="block px-5 py-3 text-white/80 hover:text-white hover:bg-white/10 rounded-lg transition-colors">
                <div className="font-medium text-base">Research & Education</div>
              </Link>
            </div>
            <div className="border-t border-white/10 p-5">
              <Link href="/sectors" className="block px-5 py-3 text-center text-blue-400 hover:text-blue-300 font-semibold transition-colors rounded-lg hover:bg-white/10">
