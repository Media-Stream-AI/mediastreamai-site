...
export default function SignupPopup() {
  ...
  return (
    ...
    >
      <div
        className="w-full max-w-xs rounded-xl bg-[#0A1525] border border-white/10 p-4 text-white"
        onClick={(e) => e.stopPropagation()}
      >
        <div className="flex justify-between items-center mb-3">
          <h2 className="text-xs font-semibold flex items-center gap-1.5">
            <Download size={14} className="text-blue-400" />
            MOTHER AI Whitepaper
          </h2>
        ...
        {!submitted ? (
          <>
            <p className="text-[11px] text-white/60 mb-3">
              Get the UK&apos;s first Sovereign LLM whitepaper.
            </p>
            ...
            >
              ...
              <input
                ...
                className="w-full rounded-md bg-black/40 border border-white/10 px-2.5 py-1.5 text-xs focus:outline-none focus:border-blue-400"
              />
              ...
              <button
                type="submit"
                className="w-full rounded-md bg-blue-500/90 hover:bg-blue-500 transition text-xs py-1.5 font-medium flex items-center justify-center gap-1.5"
              >
                <Download size={12} />
                Download PDF
              </button>
              ...
              <p className="text-[10px] text-white/40 text-center">
                UK Sovereign · GDPR Compliant · No Spam
              </p>
            </form>
          </>
        ) : (
          <div className="py-3 text-center">
            ...
            <h3 className="text-xs font-semibold mb-1">Thank you!</h3>
