  ...
  return (
    <section className="relative isolate overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-6 py-24 sm:py-32 text-center">
        <motion.h1 initial={{ opacity: 0, y: 18 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }} className="font-horizon text-5xl sm:text-6xl md:text-7xl leading-[1.05] tracking-tight">
          IntuiTV
        </motion.h1>
        <motion.p initial={{ opacity: 0, y: 14 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6, delay: 0.1 }} className="mt-5 text-white/80 max-w-2xl mx-auto font-glacial">
        ...
        <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }} transition={{ duration: 0.6, delay: 0.25 }} className="mt-8 flex items-center justify-center gap-3">
  ...
  return (
    <section id="channels" className="section border-t border-white/10">
      <div className="max-w-7xl mx-auto px-6">
        ...
        {/* Merge animation placeholder (simple static merge to logo) */}
      ...
      <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-10 items-center">
        <div>
          ...
          <p className="mt-4 text-white/70 font-glacial">
            IntuiTV is the first truly personal TV channel — a stream broadcast just to <i>you</i>. Our AI blends your viewing
            behavior with consented biometric and contextual signals to continuously learn and adapt. The lineup updates in real-time as your context changes.
          </p>
        ...
        <div className="rounded-3xl border border-white/10 bg-white/[0.03] p-6">
          ...
          <p className="mt-3 text-white/60 text-sm font-glacial">Illustrative pipeline of personalization flow</p>
        </div>
      </div>
    </section>
  );
...
function FAQ() {
  const faqs = [
    ...
    { q: "Which platforms are supported?", a: "Apple TV, Fire TV, Roku, Android TV, Samsung TV, LG webOS, iOS, and Android. More platforms are coming soon." },
    ...
    <section id="download" className="section border-t border-white/10 text-center relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-3xl mx-auto px-6">
        ...
        <div className="mt-6 flex items-center justify-center gap-3">
          ...
          <a href="https://www.intuitv.app" target="_blank" rel="noopener noreferrer" className="rounded-xl border border-white/20 bg-white/10 px-4 py-2 text-sm hover:bg-white/15 transition">Visit intuitv.app</a>
        </div>
      </div>
    </section>
  );
