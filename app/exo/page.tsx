...
const data: PillarData = {
  ...
  media: { src: '/video/exo-robotics.mp4', label: 'MOTHER Robotics · live' },
  stats: [
    { k: '28.9 GB', v: 'World model' },
    { k: '23-DOF', v: 'Fourier N1' },
  ...
  features: [
    ...
    { icon: Bot, title: 'Humanoid (Fourier N1)', body: '23-DOF humanoid at 1 kHz L0 control with a layered cognitive stack from motor to Guardian action filter.' },
